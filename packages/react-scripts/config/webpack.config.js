...
const sassCustomized = require('./sass');
  ...
  const configuration = {
    ...
    output: {
      ...
      filename: isEnvProduction
        ? `${paths.staticPath}/js/[name].[chunkhash:8].js`
        : isEnvDevelopment && `${paths.staticPath}/js/[name].bundle.js`,
      // There are also additional JS chunk files if you use code splitting.
      chunkFilename: isEnvProduction
        ? `${paths.staticPath}/js/[name].[chunkhash:8].chunk.js`
        : isEnvDevelopment && `${paths.staticPath}/js/[name].chunk.js`,
    ...
    resolve: {
      ...
      modules: [paths.appSrc /* added by mornya */, 'node_modules'].concat(
            ...
            // extensions .module.scss or .module.sass
            {
              ...
              use: getStyleLoaders(
                ...
                },
                {
                  ...
                  options: {
                    includePaths: ['src'],
                    data: sassCustomized.data(paths.staticPath), // added by mornya
                  },
                }
              ),
              // Don't consider CSS imports dead code even if the
    ...
    plugins: [
      ...
      isEnvProduction &&
        new MiniCssExtractPlugin({
          ...
          filename: `${paths.staticPath}/css/[name].[contenthash:8].css`,
          chunkFilename: `${
            paths.staticPath
